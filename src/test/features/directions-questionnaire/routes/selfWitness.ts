...
describe('Directions Questionnaire - self witness page', () => {
  ...
  describe('on POST', () => {
    const validFormData = { selfWitness: 'true' }
    const invalidFormData = { selfWitness: undefined }
      ...
      context('when form is invalid', async () => {
        it('should render page when everything is fine', async () => {
          ...
          await request(app)
            ...
            .expect(res => expect(res).to.be.successful.withText('Do you want to give evidence as a witness?', 'div class="error-summary"'))
        })
      })
    })
  })
