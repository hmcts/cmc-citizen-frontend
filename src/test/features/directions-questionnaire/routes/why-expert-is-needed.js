...
const pagePath = paths_1.Paths.whyExpertIsNeededPage.evaluateUri({ externalId: externalId });
            ...
            context('when user authorised', () => {
                ...
                it('should render page when everything is fine', async () => {
                    ...
                    await request(app_1.app)
                        .get(pagePath)
                        .set('Cookie', `${cookieName}=ABC`)
                        .expect(res => chai_1.expect(res).to.be.successful.withText('Briefly explain why you believe an expert is needed'));
                });
            });
        });
        describe('on POST', () => {
                ...
                context('when form is invalid', async () => {
                    it('should render page when everything is fine', async () => {
                        ...
                        await request(app_1.app)
                            ...
                            .expect(res => chai_1.expect(res).to.be.successful.withText('Briefly explain why you believe an expert is needed', 'div class="error-summary"'));
                    });
                });
            });
        });
