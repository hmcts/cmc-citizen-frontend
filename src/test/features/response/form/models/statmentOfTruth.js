...
describe('StatementOfTruth', () => {
    describe('constructor', () => {
        ...
        it('should set signed to false', () => {
            ...
            chai_1.expect(model.signed).to.be.false;
        });
    });
    describe('fromObject', () => {
        it('should return an instance initialised with truthy value', () => {
            chai_1.expect(statementOfTruth_1.StatementOfTruth.fromObject(undefined)).to.eql(undefined);
        });
        it('should return a valid object for "true"', () => {
            chai_1.expect(statementOfTruth_1.StatementOfTruth.fromObject({
                type: 'basic',
                signed: 'true'
            })).to.eql(new statementOfTruth_1.StatementOfTruth(signatureType_1.SignatureType.BASIC, true));
        });
    });
    describe('validation', () => {
        ...
        describe('should reject', () => {
            [undefined, null, false].forEach((v) => {
                it(`statement of truth with ${v}`, () => {
                    const errors = validator.validateSync(new statementOfTruth_1.StatementOfTruth(signatureType_1.SignatureType.BASIC, v));
