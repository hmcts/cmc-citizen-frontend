...
const pagePath = paths_1.FullAdmissionPaths.paymentDatePage.evaluateUri({ externalId: claimStoreServiceMock.sampleClaimObj.externalId });
const draft = _.cloneDeep(draftStoreServiceMock.sampleFullAdmissionResponseDraftObj);
draft.fullAdmission.paymentIntention.paymentOption.option = paymentOption_1.PaymentType.BY_SET_DATE;
function nextDay() {
