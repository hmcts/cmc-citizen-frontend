...
const pagePath = paths_1.PartAdmissionPaths.howMuchDoYouOwePage.evaluateUri({ externalId: externalId });
const redirectPath = paths_1.Paths.taskListPage.evaluateUri({ externalId: externalId });
            ...
            context('when service is healthy', () => {
                it('should render page asking' + header + 'when already paid was set to NO', async () => {
                    ...
                    draftStoreServiceMock.resolveFind('response:partial-admission', {
                        ...
                        partialAdmission: {
                            alreadyPaid: new alreadyPaid_1.AlreadyPaid().deserialize({ alreadyPaid: new alreadyPaid_1.AlreadyPaid(yesNoOption_1.YesNoOption.NO) }),
                            howMuchDoYouOwe: new howMuchDoYouOwe_1.HowMuchDoYouOwe().deserialize({ amount: 100 })
                        }
                    });
