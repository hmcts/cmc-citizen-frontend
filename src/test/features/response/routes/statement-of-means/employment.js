...
const pagePath = paths_1.StatementOfMeansPaths.employmentPage.evaluateUri({ externalId: claimStoreServiceMock.sampleClaimObj.externalId });
            ...
            context('when response and CCJ not submitted', () => {
                ...
                it('should render page when everything is fine', async () => {
                    ...
                    await request(app_1.app)
                        .get(pagePath)
                        .set('Cookie', `${cookieName}=ABC`)
                        .expect(res => chai_1.expect(res).to.be.successful.withText('Do you have a job?'));
                });
            });
        });
    });
            ...
            describe('should update draft store and redirect', () => {
                it('to unemployed page', async () => {
                    ...
                    await request(app_1.app)
                        ...
                        .toLocation(paths_1.StatementOfMeansPaths.unemployedPage.evaluateUri({ externalId: claimStoreServiceMock.sampleClaimObj.externalId })));
                });
                it('to employers page', async () => {
                    ...
                    await request(app_1.app)
                        ...
                        .set('Cookie', `${cookieName}=ABC`)
                        .expect(res => chai_1.expect(res).to.be.redirect
                        .toLocation(paths_1.StatementOfMeansPaths.employersPage.evaluateUri({ externalId: claimStoreServiceMock.sampleClaimObj.externalId })));
                });
                it('to self-employment page', async () => {
                    ...
                    await request(app_1.app)
                        ...
                        .set('Cookie', `${cookieName}=ABC`)
                        .expect(res => chai_1.expect(res).to.be.redirect
                        .toLocation(paths_1.StatementOfMeansPaths.selfEmploymentPage.evaluateUri({ externalId: claimStoreServiceMock.sampleClaimObj.externalId })));
                });
            });
        });
    });
