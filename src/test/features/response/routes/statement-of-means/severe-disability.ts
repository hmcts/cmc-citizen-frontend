  ...
  describe('Severe Disability page', () => {
    ...
    describe('on GET', () => {
      ...
      context('when user authorised', () => {
        ...
        verifyRedirectForGetWhenAlreadyPaidInFull(severeDisabilityPage, {}, () => sessionCookie)
    ...
    describe('on POST', () => {
      ...
      context('when user authorised', () => {
        ...
        verifyRedirectForPostWhenAlreadyPaidInFull(severeDisabilityPage, {}, {}, () => sessionCookie)
