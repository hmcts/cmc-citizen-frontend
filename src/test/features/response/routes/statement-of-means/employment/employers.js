...
const pagePath = paths_1.StatementOfMeansPaths.employersPage.evaluateUri({ externalId: claimStoreServiceMock.sampleClaimObj.externalId });
const draftOverride = {
    statementOfMeans: Object.assign(Object.assign({}, draftStoreServiceMock.sampleFullAdmissionResponseDraftObj.statementOfMeans), { employment: {
            declared: true,
            employed: true
        } })
};
            ...
            context('when response and CCJ not submitted', () => {
                ...
                it('should render page when everything is fine', async () => {
                    ...
                    await request(app_1.app)
                        .get(pagePath)
                        .set('Cookie', `${cookieName}=ABC`)
                        .expect(res => chai_1.expect(res).to.be.successful.withText('Who employs you?'));
                });
            });
        });
    });
            ...
            describe('save and continue', () => {
                it('should update draft store and redirect', async () => {
                    ...
                    await request(app_1.app)
                        ...
                        .toLocation(paths_1.StatementOfMeansPaths.courtOrdersPage.evaluateUri({ externalId: claimStoreServiceMock.sampleClaimObj.externalId })));
                });
            });
