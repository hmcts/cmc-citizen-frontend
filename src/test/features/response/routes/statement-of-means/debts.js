...
const pagePath = paths_1.StatementOfMeansPaths.debtsPage.evaluateUri({ externalId: claimStoreServiceMock.sampleClaimObj.externalId });
            ...
            context('when response and CCJ not submitted', () => {
                ...
                it('should render page when everything is fine', async () => {
                    ...
                    await request(app_1.app)
                        .get(pagePath)
                        .set('Cookie', `${cookieName}=ABC`)
                        .expect(res => chai_1.expect(res).to.be.successful.withText('Do you have any debts?'));
                });
            });
        });
    });
                ...
                context('should update draft store and redirect', () => {
                    it('when valid debt provided', async () => {
                        ...
                        await request(app_1.app)
                            ...
                            .toLocation(paths_1.StatementOfMeansPaths.monthlyExpensesPage.evaluateUri({ externalId: claimStoreServiceMock.sampleClaimObj.externalId })));
                    });
