...
const pagePath = paths_1.StatementOfMeansPaths.educationPage.evaluateUri({ externalId: claimStoreServiceMock.sampleClaimObj.externalId });
const draftOverride = {
    statementOfMeans: Object.assign(Object.assign({}, draftStoreServiceMock.sampleFullAdmissionResponseDraftObj.statementOfMeans), { dependants: {
            declared: true,
            numberOfChildren: {
                between16and19: 1
            }
            ...
            context('when response and CCJ not submitted', () => {
                ...
                it('should render page when everything is fine', async () => {
                    ...
                    await request(app_1.app)
                        .get(pagePath)
                        .set('Cookie', `${cookieName}=ABC`)
                        .expect(res => chai_1.expect(res).to.be.successful.withText('Children aged 16 to 19 living with you'));
                });
            });
        });
    });
