...
describe('Claim issue: receipt', () => {
    ...
    describe('on GET', () => {
        authorization_check_1.checkAuthorizationGuards(app_1.app, 'get', paths_1.Paths.receiptReceiver.evaluateUri({ externalId: externalId }));
        describe('for authorized user', () => {
            ...
            it('should return 500 and render error page when cannot retrieve claim by external id', async () => {
                ...
                await request(app_1.app)
                    .get(paths_1.Paths.receiptReceiver.evaluateUri({ externalId: externalId }))
