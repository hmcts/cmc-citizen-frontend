...
describe('Claim issue: defendant phone page', () => {
  ...
  describe('on GET', () => {
    ...
    checkEligibilityGuards(app, 'get', ClaimPaths.defendantPhonePage.uri, () => sessionCookie)
  ...
  describe('on POST', () => {
    ...
    checkEligibilityGuards(app, 'post', ClaimPaths.defendantPhonePage.uri, () => sessionCookie)
