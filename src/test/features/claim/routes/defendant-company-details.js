...
describe('defendant as company details page', () => {
    ...
    describe('on GET', () => {
        authorization_check_1.checkAuthorizationGuards(app_1.app, 'get', paths_1.Paths.defendantCompanyDetailsPage.uri);
        eligibility_check_1.checkEligibilityGuards(app_1.app, 'get', paths_1.Paths.defendantCompanyDetailsPage.uri);
        it('should render page when everything is fine', async () => {
            idamServiceMock.resolveRetrieveUserFor('1', 'citizen');
            draftStoreServiceMock.resolveFind('claim');
            await request(app_1.app)
                .get(paths_1.Paths.defendantCompanyDetailsPage.uri)
                .set('Cookie', `${cookieName}=ABC`)
                .expect(res => chai_1.expect(res).to.be.successful.withText('Company details'));
        });
    });
    describe('on POST', () => {
        authorization_check_1.checkAuthorizationGuards(app_1.app, 'post', paths_1.Paths.defendantCompanyDetailsPage.uri);
        eligibility_check_1.checkEligibilityGuards(app_1.app, 'post', paths_1.Paths.defendantCompanyDetailsPage.uri);
        describe('for authorized user', () => {
            ...
            it('should render page with error when defendant name is invalid', async () => {
                ...
                await request(app_1.app)
                    .post(paths_1.Paths.defendantCompanyDetailsPage.uri)
                    .set('Cookie', `${cookieName}=ABC`)
                    .send(nameMissingInput)
                    .expect(res => chai_1.expect(res).to.be.successful.withText('Company details', 'div class="error-summary"', 'Enter name'));
            });
            describe('should render page with error when address is invalid', () => {
                ...
                it('line 1 is missing', async () => {
                    ...
                    await request(app_1.app)
                        ...
                        .expect(res => chai_1.expect(res).to.be.successful.withText('Company details', 'div class="error-summary"', 'Enter first address line'));
                });
                it('city is missing', async () => {
                    ...
                    await request(app_1.app)
                        ...
                        .set('Cookie', `${cookieName}=ABC`)
                        .send(invalidAddressInput)
                        .expect(res => chai_1.expect(res).to.be.successful.withText('Company details', 'div class="error-summary"', 'Enter a valid town/city'));
                });
                it('postcode is missing', async () => {
                    ...
                    await request(app_1.app)
                        ...
                        .set('Cookie', `${cookieName}=ABC`)
                        .send(invalidAddressInput)
                        .expect(res => chai_1.expect(res).to.be.successful.withText('Company details', 'div class="error-summary"', 'Enter postcode'));
                });
            });
            describe('should render page with error when selected Correspondence address option and Correspondence entered is invalid', () => {
                ...
                it('line 1 is missing', async () => {
                    ...
                    await request(app_1.app)
                        ...
                        .expect(res => chai_1.expect(res).to.be.successful.withText('Company details', 'div class="error-summary"', 'Enter first correspondence address line'));
                });
                it('city is missing', async () => {
                    ...
                    await request(app_1.app)
                        ...
                        .set('Cookie', `${cookieName}=ABC`)
                        .send(invalidCorrespondenceAddressInput)
                        .expect(res => chai_1.expect(res).to.be.successful.withText('Company details', 'div class="error-summary"', 'Enter correspondence town/city'));
                });
                it('postcode is missing', async () => {
                    ...
                    await request(app_1.app)
                        ...
                        .set('Cookie', `${cookieName}=ABC`)
                        .send(invalidCorrespondenceAddressInput)
                        .expect(res => chai_1.expect(res).to.be.successful.withText('Company details', 'div class="error-summary"', 'Enter correspondence address postcode'));
                });
            });
