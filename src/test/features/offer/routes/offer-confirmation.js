...
describe('Offer confirmation page', () => {
    ...
    describe('on GET', () => {
        authorization_check_1.checkAuthorizationGuards(app_1.app, 'get', confirmationPage);
        context('when user authorised', () => {
            ...
            it('should render page when everything is fine', async () => {
                ...
                await request(app_1.app)
                    .get(confirmationPage)
                    .set('Cookie', `${cookieName}=ABC`)
                    .expect(res => chai_1.expect(res).to.be.successful.withText('We’ve sent your offer'));
            });
        });
    });
});
