...
const pagePath = paths_1.Paths.signSettlementAgreementPage.evaluateUri({ externalId: externalId });
const taskListPagePath = paths_1.Paths.taskListPage.evaluateUri({ externalId: externalId });
const pageHeading = 'Terms of the agreement';
            ...
            context('when form is invalid', async () => {
                it('should render page', async () => {
                    ...
                    await request(app_1.app)
                        ...
                        .expect(res => chai_1.expect(res).to.be.successful.withText(pageHeading, 'div class="error-summary"'));
                });
            });
        });
    });
