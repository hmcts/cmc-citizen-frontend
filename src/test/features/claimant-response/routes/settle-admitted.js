...
const pagePath = paths_1.Paths.settleAdmittedPage.evaluateUri({ externalId: externalId });
                ...
                context('when form is invalid', async () => {
                    it('should render page', async () => {
                        ...
                        await request(app_1.app)
                            ...
                            .expect(res => chai_1.expect(res).to.be.successful.withText('Do you want to settle the claim', 'div class="error-summary"'));
                    });
                });
            });
        });
