...
const pagePath = paths_1.Paths.willYouTryMediation.evaluateUri({ externalId: claimStoreServiceMock.sampleClaimObj.externalId });
            ...
            context('when response not submitted', () => {
                ...
                it('should render page when everything is fine', async () => {
                    ...
                    await request(app_1.app)
                        .get(pagePath)
                        .set('Cookie', `${cookieName}=ABC`)
                        .expect(res => chai_1.expect(res).to.be.successful.withText('Will you try free mediation?'));
                });
            });
        });
    });
                ...
                context('when form is valid', () => {
                    ...
                    it('should redirect to mediation agreement page when everything is fine', async () => {
                        ...
                        await request(app_1.app)
                            ...
                            .toLocation(paths_1.Paths.mediationAgreementPage
