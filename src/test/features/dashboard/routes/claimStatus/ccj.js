    ...
    return [
        ...
        },
        {
            ...
            defendantAssertions: ['000MC000',
                ...
                `You said you’ll pay ${claimStoreServiceMock.sampleClaimObj.claim.claimants[0].name} £${claimStoreServiceMock.sampleClaimObj.claim.amount.rows[0].amount} before 4pm on ${momentFactory_1.MomentFactory.currentDate().subtract(5, 'days').format('D MMMM YYYY')}.`,
        ...
        },
        {
            ...
            claim: claimStoreServiceMock.sampleClaimIssueObj,
            claimOverride: Object.assign(Object.assign({}, claimStoreServiceMock.settlementWithSetDateAndAcceptation), { settlementReachedAt: momentFactory_1.MomentFactory.currentDate().subtract(1, 'days'), claimantResponse: { type: 'ACCEPTATION', formaliseOption: 'SETTLEMENT' }, countyCourtJudgment: Object.assign({}, ccjData_1.ccjAdmissionBySpecifiedDate()), countyCourtJudgmentRequestedAt: momentFactory_1.MomentFactory.currentDate().subtract(1, 'days'), response: Object.assign(Object.assign({}, fullAdmissionClaim.response), responseData_1.basePayByInstalmentsData) }),
            claimantAssertions: ['000MC050',
                'You requested a County Court Judgment against John Doe',
                'When we’ve processed your request, we’ll post a copy of the judgment to you and to John Doe',
                'View the repayment plan',
...
const claimPagePath = paths_1.Paths.claimantPage.evaluateUri({ externalId: claimStoreServiceMock.sampleClaimObj.externalId });
const defendantPagePath = paths_1.Paths.defendantPage.evaluateUri({ externalId: claimStoreServiceMock.sampleClaimObj.externalId });
