...
function legacyClaimDetails() {
    return [
        ...
        },
        {
            ...
            claim: partAdmissionClaim(),
            claimOverride: Object.assign({ response: Object.assign(Object.assign({}, partAdmissionClaim().response), responseData_1.basePayBySetDateData), claimantResponse: Object.assign({}, partAdmitData_1.claimantAcceptRepaymentPlan), claimantRespondedAt: momentFactory_1.MomentFactory.currentDate() }, partAdmitData_1.settlementOfferAcceptBySetDate()),
        ...
        },
        {
            ...
            claim: partAdmissionClaim(),
            claimOverride: Object.assign({ response: Object.assign(Object.assign({}, partAdmissionClaim().response), responseData_1.basePayBySetDateData), claimantResponse: Object.assign({}, partAdmitData_1.claimantAcceptRepaymentPlanByDetermination()), claimantRespondedAt: momentFactory_1.MomentFactory.currentDate() }, partAdmitData_1.settlementOfferAcceptBySetDate()),
            claimantAssertions: ['You’ve signed a settlement agreement',
                `We’ve emailed ${partAdmissionClaim().claim.defendants[0].name} the repayment plan and the settlement agreement for them to sign.`,
                'They must respond by',
                'We’ll email you when they respond.',
        ...
        },
        {
            ...
            claim: partAdmissionClaim(),
            claimOverride: Object.assign({ response: Object.assign(Object.assign({}, partAdmissionClaim().response), responseData_1.basePayByInstalmentsData), claimantResponse: Object.assign({}, partAdmitData_1.claimantAcceptRepaymentPlan), claimantRespondedAt: momentFactory_1.MomentFactory.currentDate() }, partAdmitData_1.settlementOfferAcceptInInstalment()),
            claimantAssertions: ['You’ve signed a settlement agreement',
                `We’ve emailed ${partAdmissionClaim().claim.defendants[0].name} the repayment plan and the settlement agreement for them to sign.`,
                'They must respond by',
                'We’ll email you when they respond.',
        ...
        },
        {
            ...
            claim: partAdmissionClaim(),
            claimOverride: Object.assign({ response: Object.assign(Object.assign({}, partAdmissionClaim().response), responseData_1.basePayByInstalmentsData), claimantResponse: Object.assign({}, partAdmitData_1.claimantAcceptRepaymentPlanInInstalmentsByDetermination()), claimantRespondedAt: momentFactory_1.MomentFactory.currentDate() }, partAdmitData_1.settlementOfferAcceptInInstalment()),
            claimantAssertions: ['You’ve signed a settlement agreement',
                `We’ve emailed ${partAdmissionClaim().claim.defendants[0].name} the repayment plan and the settlement agreement for them to sign.`,
                'They must respond by',
                'We’ll email you when they respond.',
        ...
        },
        {
            ...
            claim: partAdmissionClaim(),
            claimOverride: Object.assign({ features: ['admissions'], response: Object.assign(Object.assign(Object.assign({}, responseData_1.baseResponseData), responseData_1.basePartialAdmissionData), { freeMediation: freeMediation_1.FreeMediationOption.NO }), claimantResponse: {
                    settleForAmount: 'no',
                    type: 'REJECTION',
        ...
        },
        {
            ...
            claim: partAdmissionClaim(),
            claimOverride: Object.assign({ features: ['admissions'], response: Object.assign(Object.assign(Object.assign({}, responseData_1.baseResponseData), responseData_1.basePartialAdmissionData), { freeMediation: freeMediation_1.FreeMediationOption.YES }), claimantResponse: {
                    settleForAmount: 'no',
...
const mediationDQEnabledClaimDetails = [
    {
        ...
        claimOverride: {
            ...
            response: Object.assign(Object.assign(Object.assign({}, responseData_1.baseResponseData), responseData_1.basePartialAdmissionData), { freeMediation: freeMediation_1.FreeMediationOption.NO, directionsQuestionnaire: {
                    hearingLoop: 'NO',
                    selfWitness: 'NO',
                    disabledAccess: 'NO',
    ...
    },
    {
        ...
        claimOverride: {
            features: ['admissions', 'directionsQuestionnaire'],
            response: Object.assign(Object.assign(Object.assign({}, responseData_1.baseResponseData), responseData_1.basePartialAdmissionData), { freeMediation: freeMediation_1.FreeMediationOption.YES, directionsQuestionnaire: {
                    hearingLoop: 'NO',
                    selfWitness: 'NO',
                    disabledAccess: 'NO',
                    hearingLocation: 'Central London County Court',
    ...
    },
    {
        ...
        claim: partAdmissionClaim(),
        claimOverride: Object.assign(Object.assign({ features: ['admissions', 'directionsQuestionnaire'], response: Object.assign(Object.assign(Object.assign({}, responseData_1.baseResponseData), responseData_1.basePartialAdmissionData), { freeMediation: freeMediation_1.FreeMediationOption.YES, directionsQuestionnaire: {
                    hearingLoop: 'NO',
                    selfWitness: 'NO',
                    disabledAccess: 'NO',
                    hearingLocation: 'Central London County Court',
    ...
    },
    {
        ...
        claim: partAdmissionClaim(),
        claimOverride: Object.assign(Object.assign({ features: ['admissions', 'directionsQuestionnaire'], response: Object.assign(Object.assign(Object.assign({}, responseData_1.baseResponseData), responseData_1.basePartialAdmissionData), { freeMediation: freeMediation_1.FreeMediationOption.YES }), claimantResponse: {
                settleForAmount: 'no',
                freeMediation: freeMediation_1.FreeMediationOption.YES,
                type: 'REJECTION'
...
const claimPagePath = paths_1.Paths.claimantPage.evaluateUri({ externalId: partAdmissionClaim().externalId });
const defendantPagePath = paths_1.Paths.defendantPage.evaluateUri({ externalId: partAdmissionClaim().externalId });
