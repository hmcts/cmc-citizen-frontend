...
const contactThemPage = paths_1.Paths.contactThemPage.evaluateUri({ externalId: 'b17af4d2-273f-4999-9895-bce382fa24c8' });
describe('Dashboard - Contact-them page', () => {
    hooks_1.attachDefaultHooks(app_1.app);
    describe('on GET', () => {
        authorization_check_1.checkAuthorizationGuards(app_1.app, 'get', contactThemPage);
            ...
            context('when at least one claim issued', () => {
                ...
                it('should render page when everything is fine', async () => {
                    await request(app_1.app)
                        .get(contactThemPage)
                        .set('Cookie', `${cookieName}=ABC`)
                        .expect(res => chai_1.expect(res).to.be.successful.withText('Address'));
                });
            });
        });
    });
