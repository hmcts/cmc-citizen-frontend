...
import { customAccessibilityChecks, checkInputLabels, checkTaskList, checkAnswers, checkError, CustomChecks, checkRole, checkButton, checkEligibilityLinks, checkTable, checkHeadingLevels } from './customChecks'
...
const testsOnSpecificPages: TestsOnSpecificPages[] = [
  ...
  {
    routes: [DefendantResponsePaths.timelinePage, DefendantResponsePaths.evidencePage, DirectionQuestionnairePaths.hearingLocationPage],
    tests: [checkHeadingLevels]
  }
]
