export const mockCountryLookupResponse = {
  'header': {
    'uri': 'https://api.os.uk/search/names/v1/find?query=SW2%201AN&maxresults=1&fq=LOCAL_TYPE%3APostcode',
    'query': 'SW2 1AN',
    'format': 'JSON',
    'maxresults': 1,
    'offset': 0,
...
export const mockScottishCountryLookupResponse = {
  'header': {
    'uri': 'https://api.os.uk/search/names/v1/find?query=EH9%201SH&maxresults=1&fq=LOCAL_TYPE%3APostcode',
    'query': 'EH9 1SH',
    'format': 'JSON',
    'maxresults': 1,
    'offset': 0,
