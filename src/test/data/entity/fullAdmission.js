...
function courtDeterminationBySpecifiedDate() {
    return {
        courtDecision: Object.assign({}, setByDatePaymentIntention()),
...
function claimantResponseAt() {
    return {
        claimantRespondedAt: momentFactory_1.MomentFactory.currentDate()
    };
}
exports.claimantResponseAt = claimantResponseAt;
function defendantOffersSettlementBySetDate() {
    return [{
            ...
            offer: {
                ...
                paymentIntention: Object.assign({}, setByDatePaymentIntention())
            }
        }];
}
...
exports.defendantOffersSettlementByInstalments = defendantOffersSettlementByInstalments;
function defendantOffersSettlementBySetDatePastPaymentDeadline() {
    return [{
            ...
            offer: {
                ...
                paymentIntention: Object.assign({}, setByDatePaymentIntentionPastDeadline())
            }
        }];
}
