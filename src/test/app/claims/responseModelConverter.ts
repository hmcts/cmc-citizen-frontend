...
export class ResponseModelConverter {
  ...
  private static convertFullDefence (draft: ResponseDraft, claim: Claim, mediationDraft: MediationDraft, directionsQuestionnaireDraft: DirectionsQuestionnaireDraft): FullDefenceResponse {
    return {
      ...
      freeMediation: this.convertFreeMediation(mediationDraft),
  ...
  private static convertFreeMediation (mediationDraft: MediationDraft): YesNoOption {
    return FreeMediationUtil.getFreeMediation(mediationDraft)
