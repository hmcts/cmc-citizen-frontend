...
export class Frequency {
  ...
  static readonly TWO_WEEKLY = new Frequency(['TWO_WEEK', 'EVERY_TWO_WEEKS', 'TWO_WEEKS'], 52 / 12 / 2, 2, 'Every 2 weeks')
  static readonly FOUR_WEEKLY = new Frequency(['FOUR_WEEK', 'EVERY_FOUR_WEEKS', 'FOUR_WEEKS'], 52 / 12 / 4, 4, 'Every 4 weeks')
