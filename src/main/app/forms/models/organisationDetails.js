...
class OrganisationDetails extends partyDetails_1.PartyDetails {
    constructor() {
        super();
    ...
    static fromObject(input) {
        ...
        deserialized.type = partyType_1.PartyType.ORGANISATION.value;
        return deserialized;
    }
    deserialize(input) {
        if (input) {
...
__decorate([
    cmc_validators_1.MaxLength(ValidationConstraints.CONTACT_PERSON_MAX_LENGTH, { message: ValidationErrors.CONTACT_PERSON_NAME_TOO_LONG, groups: ['claimant', 'response'] })
], OrganisationDetails.prototype, "contactPerson", void 0);
exports.OrganisationDetails = OrganisationDetails;
