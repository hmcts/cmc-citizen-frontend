...
let DateTodayOrInFutureConstraint = class DateTodayOrInFutureConstraint {
    validate(value, args) {
        if (value === undefined) {
            return true;
        }
...
DateTodayOrInFutureConstraint = __decorate([
    class_validator_1.ValidatorConstraint()
], DateTodayOrInFutureConstraint);
exports.DateTodayOrInFutureConstraint = DateTodayOrInFutureConstraint;
function IsTodayOrInFuture(validationOptions) {
