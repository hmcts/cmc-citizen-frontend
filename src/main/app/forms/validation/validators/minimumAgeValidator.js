...
let MinimumAgeValidatorConstraint = class MinimumAgeValidatorConstraint {
    validate(value, args) {
...
MinimumAgeValidatorConstraint = __decorate([
    class_validator_1.ValidatorConstraint()
], MinimumAgeValidatorConstraint);
exports.MinimumAgeValidatorConstraint = MinimumAgeValidatorConstraint;
/**
 * Verify is a within age limit.
 */
function MinimumAgeValidator(minYears, validationOptions) {
...
exports.MinimumAgeValidator = MinimumAgeValidator;
