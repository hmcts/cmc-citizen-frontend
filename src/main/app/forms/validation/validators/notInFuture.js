...
let DateNotInFutureConstraint = class DateNotInFutureConstraint {
    validate(value, args) {
        if (value === undefined) {
            return true;
        }
...
DateNotInFutureConstraint = __decorate([
    class_validator_1.ValidatorConstraint()
], DateNotInFutureConstraint);
exports.DateNotInFutureConstraint = DateNotInFutureConstraint;
