...
export class ContentSecurityPolicy {
  ...
  enableFor (app: express.Express) {
    ...
    const scriptSrc = [inlineJsEnabledBodyClassName, additionalClassName, inlineJsWindowGOVUKClassName, self, '*.google-analytics.com', 'vcc-eu4.8x8.com','vcc-eu4b.8x8.com']
