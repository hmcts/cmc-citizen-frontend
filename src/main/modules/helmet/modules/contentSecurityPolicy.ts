...
export class ContentSecurityPolicy {
  ...
  enableFor (app: express.Express) {
    ...
    const connectSrc = [self, '*.gov.uk', 'https://webchat-client.training.ctsc.hmcts.net', 'wss://webchat.training.ctsc.hmcts.net', 'https://webchat.training.ctsc.hmcts.net', '*.google-analytics.com']
    const scriptSrcElem = [self, '*.google-analytics.com', 'https://webchat-client.training.ctsc.hmcts.net', 'wss://webchat.training.ctsc.hmcts.net', 'https://webchat.training.ctsc.hmcts.net']
