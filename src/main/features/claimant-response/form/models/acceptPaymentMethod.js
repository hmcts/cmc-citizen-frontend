...
class AcceptPaymentMethod {
    ...
    static fromObject(input) {
        ...
        return new AcceptPaymentMethod(yesNoOption_1.YesNoOption.fromObject(input.accept));
    }
    deserialize(input) {
...
], AcceptPaymentMethod.prototype, "accept", void 0);
exports.AcceptPaymentMethod = AcceptPaymentMethod;
