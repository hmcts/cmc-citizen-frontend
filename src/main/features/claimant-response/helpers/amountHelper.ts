...
export function calculateTotalAmount (claim: Claim, draft: DraftClaimantResponse): number | undefined {
  const settledAmount = calculateAmountSettledFor(claim, draft)
...
export function calculateAmountSettledFor (claim: Claim, draft: DraftClaimantResponse): number | undefined {
