...
function renderView (form: Form<CanWeUse>, res: express.Response): void {
  ...
  res.render(Paths.confirmTelephoneNumberPage.associatedView, {
    form: form,
...
export default express.Router()
  .get(Paths.confirmTelephoneNumberPage.uri, (req: express.Request, res: express.Response): void => {
    const draft: Draft<MediationDraft> = res.locals.mediationDraft

    renderView(new Form(draft.document.canWeUse), res)
  })
  .post(
    Paths.confirmTelephoneNumberPage.uri,
