...
export class Paths {
  ...
  static readonly paymentMethodPage = new RoutablePath('/claim/payment-method')
  static readonly confirmHelpWithFeesPage = new RoutablePath('/claim/confirm-help-with-fees')
