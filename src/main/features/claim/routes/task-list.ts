...
import { FeaturePermissionMiddleware } from 'claims/featurePermissionMiddleware'

/* tslint:disable:no-default-export */
export default express.Router()
  .get(Paths.taskListPage.uri, FeaturePermissionMiddleware.retrieveUserConsentRole, (req: express.Request, res: express.Response) => {
