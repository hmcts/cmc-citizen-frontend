...
import { NewFeatureConsentMiddleware } from 'claims/newFeatureConsentMiddleware'

/* tslint:disable:no-default-export */
export default express.Router()
  .get(Paths.taskListPage.uri, NewFeatureConsentMiddleware.retrieveUserConsentRole, (req: express.Request, res: express.Response) => {
