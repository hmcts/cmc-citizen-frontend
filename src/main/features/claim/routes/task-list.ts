...
import { NewFeaturesConsentMiddleware } from 'claims/newFeaturesConsentMiddleware'

/* tslint:disable:no-default-export */
export default express.Router()
  .get(Paths.taskListPage.uri, NewFeaturesConsentMiddleware.retrieveUserConsentRole, (req: express.Request, res: express.Response) => {
