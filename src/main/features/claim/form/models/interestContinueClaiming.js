...
class InterestContinueClaiming {
    constructor(option) {
        this.option = option;
    }
    static fromObject(input) {
        ...
        return new InterestContinueClaiming(yesNoOption_1.YesNoOption.fromObject(input.option));
    }
    deserialize(input) {
...
], InterestContinueClaiming.prototype, "option", void 0);
exports.InterestContinueClaiming = InterestContinueClaiming;
