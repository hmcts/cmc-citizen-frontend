...
export class Paths {
  ...
  static readonly repaymentPlanSummaryPage = new RoutablePath(`${ccjPath}/repayment-plan-summary`)
  static readonly redeterminationPage = new RoutablePath(`${ccjPath}/redetermination`)
