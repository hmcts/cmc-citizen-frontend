...
export class Paths {
  ...
  static readonly offerPage = new RoutablePath(`${responsePath}/your-offer`)
  static readonly settleOutOfCourtPage = new RoutablePath(`${responsePath}/settle-out-of-court`)
  ...
  static readonly offerSentConfirmationPage = new RoutablePath(`${responsePath}/offer-sent-confirmation`)
