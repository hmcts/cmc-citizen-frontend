...
export class ValidationErrors {
  static readonly DESCRIPTION_REQUIRED: string = 'Enter a name for the income you added'
  static readonly AMOUNT_REQUIRED: string = 'Enter an amount for the income you added'
...
export class ValidationConstraints {
  static readonly STANDARD_TEXT_INPUT_MAX_LENGTH: string = 'Enter a name for the income you added'
  static readonly AMOUNT_REQUIRED: string = 'Enter an amount for the income you added'
  static readonly AMOUNT_INVALID_DECIMALS: string = 'Enter valid amount, maximum two decimal places for the income you added'
  static readonly POSITIVE_NUMBER_REQUIRED: string = 'Enter a number higher than 0 for the field you added'
  static readonly TEXT_TOO_LONG: string = 'You’ve entered too many characters for the income you added'
}
...
export class AmountDescriptionRow extends MultiRowFormItem {
  ...
  @MaxLength(ValidationConstraints.STANDARD_TEXT_INPUT_MAX_LENGTH, { message: ValidationErrors.TEXT_TOO_LONG })
  description?: string
