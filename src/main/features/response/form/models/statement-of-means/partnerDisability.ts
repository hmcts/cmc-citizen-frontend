...
export class PartnerDisability {
  ...
  public static fromObject (input?: any): PartnerDisability {
    if (!input) {
      return input
    }

    return new PartnerDisability(YesNoOption.fromObject(input.option))
  }

  deserialize (input?: any): PartnerDisability {
