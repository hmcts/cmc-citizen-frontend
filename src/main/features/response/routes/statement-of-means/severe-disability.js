...
const page = paths_1.StatementOfMeansPaths.severeDisabilityPage;
...
exports.default = express.Router()
    ...
    res.render(page.associatedView, {
        form: new form_1.Form(draft.document.statementOfMeans.severeDisability)
    });
})
    .post(page.uri, statementOfMeansStateGuard_1.StatementOfMeansStateGuard.requestHandler(), formValidator_1.FormValidator.requestHandler(severeDisability_1.SevereDisability), errorHandling_1.ErrorHandling.apply(async (req, res, next) => {
    const form = req.body;
