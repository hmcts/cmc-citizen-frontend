...
const page = paths_1.StatementOfMeansPaths.onTaxPaymentsPage;
...
exports.default = express.Router()
    ...
    const draft = res.locals.responseDraft;
    res.render(page.associatedView, { form: new form_1.Form(draft.document.statementOfMeans.onTaxPayments) });
})
    .post(page.uri, statementOfMeansStateGuard_1.StatementOfMeansStateGuard.requestHandler(), stateGuardRequestHandler, formValidator_1.FormValidator.requestHandler(onTaxPayments_1.OnTaxPayments, onTaxPayments_1.OnTaxPayments.fromObject), errorHandling_1.ErrorHandling.apply(async (req, res) => {
    const form = req.body;
    if (form.hasErrors()) {
