...
const page = paths_1.StatementOfMeansPaths.partnerSevereDisabilityPage;
...
exports.default = express.Router()
    ...
    res.render(page.associatedView, {
        form: new form_1.Form(draft.document.statementOfMeans.partnerSevereDisability)
    });
})
    .post(page.uri, statementOfMeansStateGuard_1.StatementOfMeansStateGuard.requestHandler(), formValidator_1.FormValidator.requestHandler(partnerSevereDisability_1.PartnerSevereDisability), errorHandling_1.ErrorHandling.apply(async (req, res, next) => {
    const form = req.body;
