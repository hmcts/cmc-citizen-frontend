...
const page = paths_1.StatementOfMeansPaths.partnerPensionPage;
...
exports.default = express.Router()
    ...
    res.render(page.associatedView, {
        form: new form_1.Form(draft.document.statementOfMeans.partnerPension)
    });
})
    .post(page.uri, statementOfMeansStateGuard_1.StatementOfMeansStateGuard.requestHandler(), formValidator_1.FormValidator.requestHandler(partnerPension_1.PartnerPension), errorHandling_1.ErrorHandling.apply(async (req, res, next) => {
    const form = req.body;
    ...
    if (form.hasErrors()) {
        ...
        if (draft.document.statementOfMeans.disability && draft.document.statementOfMeans.disability.option === disability_1.DisabilityOption.YES) {
