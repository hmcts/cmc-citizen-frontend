...
class PermissionForExpert {
    constructor(requestPermissionForExpert) {
    ...
    static fromObject(input) {
        ...
        return new PermissionForExpert(yesNoOption_1.YesNoOption.fromObject(input.option));
    }
    deserialize(input) {
...
], PermissionForExpert.prototype, "option", void 0);
exports.PermissionForExpert = PermissionForExpert;
