...
class ExpertRequired {
    ...
    static fromObject(input) {
        ...
        return new ExpertRequired(yesNoOption_1.YesNoOption.fromObject(input.option));
    }
    deserialize(input) {
...
], ExpertRequired.prototype, "option", void 0);
exports.ExpertRequired = ExpertRequired;
