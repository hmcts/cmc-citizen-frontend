...
xhttp.onreadystatechange = function () {
  if (this.readyState == 4 && this.status == 200) {
    ...
    webchat_init({
      ...
      textChatClosed: 'Web chat is now closed. Come back Monday to Thursday 8:30am to 5:00pm and Friday 8:30am to 4:00pm, or contact us by phone or email.',
      ...
      textAdditional: 'Monday to Thursday 9am to 5pm and Friday 8:30am to 4:00pm.',
