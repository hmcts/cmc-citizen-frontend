...
import { claimAmount, createClaimant, claimReason, createDefendant, postCodeLookup, SMOKE_TEST_CITIZEN_USERNAME, SMOKE_TEST_USER_PASSWORD } from 'integration-tests/data/test-data'
import { CitizenCompletingClaimInfoPage } from 'integration-tests/tests/citizen/claim/pages/citizen-completing-claim-info'
import { CitizenDobPage } from 'integration-tests/tests/citizen/claim/pages/citizen-dob'
import { CitizenEmailPage } from 'integration-tests/tests/citizen/claim/pages/citizen-email'
import { CitizenMobilePage } from 'integration-tests/tests/citizen/claim/pages/citizen-mobile'
import { CitizenResolveDisputePage } from 'integration-tests/tests/citizen/claim/pages/citizen-resolve-dispute'
import { ClaimantCheckAndSendPage } from 'integration-tests/tests/citizen/claim/pages/claimant-check-and-send'
import { ClaimantClaimAmountPage } from 'integration-tests/tests/citizen/claim/pages/claimant-claim-amount'
import { ClaimantClaimConfirmedPage } from 'integration-tests/tests/citizen/claim/pages/claimant-claim-confirmed'
import { ClaimantFeesToPayPage } from 'integration-tests/tests/citizen/claim/pages/claimant-fees-to-pay'
import { ClaimantReasonPage } from 'integration-tests/tests/citizen/claim/pages/claimant-reason'
import { CompanyDetailsPage } from 'integration-tests/tests/citizen/claim/pages/company-details'
import { IndividualDetailsPage } from 'integration-tests/tests/citizen/claim/pages/individual-details'
import { OrganisationDetailsPage } from 'integration-tests/tests/citizen/claim/pages/organisation-details'
import { PartyTypePage } from 'integration-tests/tests/citizen/claim/pages/party-type'
import { EligibilitySteps } from 'integration-tests/tests/citizen/claim/steps/eligibility'
import { InterestSteps } from 'integration-tests/tests/citizen/claim/steps/interest'
import { PaymentSteps } from 'integration-tests/tests/citizen/claim/steps/payment'
