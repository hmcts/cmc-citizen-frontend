...
Scenario('Navigate Payment Page by providing claim details... ', { retries: 3 }, async (I: I) => {
...
Scenario(' Navigate Payment Page by Providing HWF reference...  ', { retries: 3 }, async (I: I) => {
