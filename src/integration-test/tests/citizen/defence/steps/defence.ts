import { DEFAULT_PASSWORD, createDefendant, defence } from 'integration-tests/data/test-data'
import { request } from 'integration-tests/helpers/clients/base/request'
import { DefendantCheckAndSendPage } from 'integration-tests/tests/citizen/defence/pages/defendant-check-and-send'
import { DefendantDefenceTypePage } from 'integration-tests/tests/citizen/defence/pages/defendant-defence-type'
import { DefendantDobPage } from 'integration-tests/tests/citizen/defence/pages/defendant-dob'
import { DefendantEnterClaimPinNumberPage } from 'integration-tests/tests/citizen/defence/pages/defendant-enter-claim-pin-number'
import { DefendantEnterClaimReferencePage } from 'integration-tests/tests/citizen/defence/pages/defendant-enter-claim-reference'
import { DefendantFreeMediationPage } from 'integration-tests/tests/citizen/defence/pages/defendant-free-mediation'
import { DefendantHowMuchHaveYouPaidPage } from 'integration-tests/tests/citizen/defence/pages/defendant-how-much-have-you-paid'
import { DefendantHowMuchYouOwePage } from 'integration-tests/tests/citizen/defence/pages/defendant-how-much-you-owe'
import { DefendantImpactOfDisputePage } from 'integration-tests/tests/citizen/defence/pages/defendant-impact-of-dispute'
import { DefendantMobilePage } from 'integration-tests/tests/citizen/defence/pages/defendant-mobile'
import { DefendantMoreTimeConfirmationPage } from 'integration-tests/tests/citizen/defence/pages/defendant-more-time-confirmation'
import { DefendantMoreTimeRequestPage } from 'integration-tests/tests/citizen/defence/pages/defendant-more-time-request'
import { DefendantNameAndAddressPage } from 'integration-tests/tests/citizen/defence/pages/defendant-name-and-address'
import { DefendantPaymentPlanPage } from 'integration-tests/tests/citizen/defence/pages/defendant-payment-plan'
import { DefendantRegisterPage } from 'integration-tests/tests/citizen/defence/pages/defendant-register'
import { DefendantRejectAllOfClaimPage } from 'integration-tests/tests/citizen/defence/pages/defendant-reject-all-of-claim'
import { DefendantRejectPartOfClaimPage } from 'integration-tests/tests/citizen/defence/pages/defendant-reject-part-of-claim'
import { DefendantStartPage } from 'integration-tests/tests/citizen/defence/pages/defendant-start'
import { DefendantTimelineEventsPage } from 'integration-tests/tests/citizen/defence/pages/defendant-timeline-events'
import { DefendantViewClaimPage } from 'integration-tests/tests/citizen/defence/pages/defendant-view-claim'
import { DefendantWhenWillYouPayPage } from 'integration-tests/tests/citizen/defence/pages/defendant-when-will-you-pay'
import { DefendantYourDefencePage } from 'integration-tests/tests/citizen/defence/pages/defendant-your-defence'
import { StatementOfMeansSteps } from 'integration-tests/tests/citizen/defence/steps/statementOfMeans'
import { LoginPage } from 'integration-tests/tests/citizen/home/pages/login'
import { DefendantSteps } from 'integration-tests/tests/citizen/home/steps/defendant'
import I = CodeceptJS.I
import { PartyType } from 'integration-tests/data/party-type'
import { DefenceType } from 'integration-tests/data/defence-type'
import { DefendantHowMuchHaveYouPaidClaimantPage } from 'integration-tests/tests/citizen/defence/pages/defendant-how-much-have-you-paid-claimant'
import { DefendantWhenDidYouPayPage } from 'integration-tests/tests/citizen/defence/pages/defendant-when-did-you-pay'
