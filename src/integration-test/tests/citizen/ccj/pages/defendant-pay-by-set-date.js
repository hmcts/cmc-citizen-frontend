...
class DefendantPayBySetDatePage {
    paymentBySetDate(paymentDate) {
        const [year, month, day] = date_parser_1.DateParser.parse(paymentDate);
...
exports.DefendantPayBySetDatePage = DefendantPayBySetDatePage;
