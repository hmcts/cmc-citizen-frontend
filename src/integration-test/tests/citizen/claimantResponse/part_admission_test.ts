...
if (process.env.FEATURE_ADMISSIONS === 'true') {
  ...
  xScenario('I can as a claimant accept the defendants part admission by instalments with settlement agreement and rejecting defendants payment method in favour of immediate payment @citizen @admissions @e2e', { retries: 3 }, async (I: I) => {
